    ...
    <div id="page" class="container-fluid col-lg-9 p-1 m-0 d-flex flex-column max-vh-100 min-vh-100 vh-100 " style="background-color: var(--primarycolor);margin-top: 56px;">
        ...
        <div id="Reference" class="col-11 d-flex flex-column p-2 align-self-center mb-2" style="background-color: #0b4358">
            <h1 class="text-light">Nos référence</h1>
                ...
                <div class="col-auto">
                    <p class="text-light">
                        TextetexteTextetexteTextetexteTextetexteTextetex
                        teTextetexteTextetexteTextetexteTextetexteTextetexte
                    </p>
                </div>
        </div>
...
<!--    mention-->
<!--    <div class="accordion d-none d-sm-none d-md-none d-lg-none d-xl-none w-100 mw-100" id="accordion2" style="background-color:var(--secondarycolor)">-->
<!--        <div class="card w-100" id="colorContact" style="background-color:var(--secondarycolor)">-->
<!--            <div id="heading2" class="w-100 p-0" style="background-color:var(--secondarycolor)">-->
<!--                <button id="btnMention" class="w-100 border-0  pl-5 pr-3 text-light" type="button" data-toggle="collapse" data-target="#collapse2" aria-expanded="true" aria-controls="collapse2" style="background-color:var(--secondarycolor)">-->
<!--                    Mentions légales-->
...
<!--nav-bar mobile-->
<div class="test w-100 d-flex d-sm-flex d-md-flex d-lg-none d-xl-none " style="position: sticky; bottom: 0;z-index: 1020">
